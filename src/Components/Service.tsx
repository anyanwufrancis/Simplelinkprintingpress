...
export default function Service (){
    const ServiceProducts = [
        ...
        {id: 3, image: "/Flyer.jpg", title: "Flyer Printing", text:"High-quality flyer printing for promotions, events, and marketing campaigns—crafted to grab attention and drive results."},
    ...
    return (
        <Box>
        <Flex alignItems={"center"} justifyContent={"center"} style={{backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.3)), url(/printer-background.jpeg)", backgroundSize: "cover", height: "20pc", width: "100%"}}>
        ...
        <Flex 
            ...
            bgColor={"pink.600"}
        >
            <Link position={"relative"} zIndex={"10000"} _hover={{color: "black"}} href="/">
                <Box>
                <FaHome
                    fontSize={"25"}
                />
